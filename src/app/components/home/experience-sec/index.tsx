  ...
  const experiences = [
    {
      ...
      type: "Internship",
      description:
        "Developed scalable UI components and admin dashboards with React.js and Next.js, optimizing performance through server-side rendering.  ",
    },
    {
      year: "2024",
      title: "Frontend Developer",
      ...
      description:
        "Built responsive web interfaces with Bootstrap and JavaScript.",
    },
    // {
    //   year: "2020-2022",
